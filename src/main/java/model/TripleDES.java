...
public class TripleDES extends AEncryptionAlgorithm implements IEncryptionAlgorithm{
    public TripleDES() {
        validKeySize = new String[]{"112","168"};
    }
    ...
    public void importKey(String keyInput){
        ...
        SecretKey secretKey = new SecretKeySpec(decodedKeyBytes, "DESede");
        setKey(secretKey);
    }
