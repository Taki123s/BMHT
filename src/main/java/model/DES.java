...
public class DES extends AEncryptionAlgorithm implements IEncryptionAlgorithm{

    public DES(){
        validKeySize = new String[]{"56"};
    }
    ...
    public void importKey(String keyInput){
        ...
        SecretKey secretKey = new SecretKeySpec(decodedKeyBytes, "DES");
        setKey(secretKey);
    }
